...
if __name__ == "__main__":
    ...
    output_path = "/media/pavlos/One Touch/datasets/gt_generation/royal-field/meshing"

    radius = 0.01
    v = centers.numpy()
    idx = pcu.downsample_point_cloud_poisson_disk(v, radius, target_num_samples=10000)

    with open(f"{output_path}/subsampled_poisson_10000.obj", "w") as f:
